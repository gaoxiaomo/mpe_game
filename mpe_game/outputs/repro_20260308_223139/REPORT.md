...
- Output folder: `outputs\repro_20260308_223139`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 156.164
- Final team error: 343.789
- Capture time (s): 21.55

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 574.313
- Fixed graph final team error ([26] baseline run): 574.246
- Fixed-reference final team error (same trajectory): 574.313
