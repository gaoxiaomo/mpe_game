...
- Output folder: `outputs\repro_20260308_222814`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 15937.746
- Final team error: 36800.133
- Capture time (s): None

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 28679.479
- Fixed graph final team error ([26] baseline run): 29857.765
- Fixed-reference final team error (same trajectory): 29855.995
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [96.95]
