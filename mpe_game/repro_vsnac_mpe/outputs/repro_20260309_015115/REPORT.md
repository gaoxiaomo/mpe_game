...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_015115`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 159.978
- Final team error: 338.718
- Capture time (s): 41.0

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 548.480
- Fixed graph final team error ([26] baseline run): 523.903
- Fixed-reference final team error (same trajectory): 548.480
