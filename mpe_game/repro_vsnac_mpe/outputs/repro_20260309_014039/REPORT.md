...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_014039`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 28234.929
- Final team error: 75697.848
- Capture time (s): None

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 62921.492
- Fixed graph final team error ([26] baseline run): 62922.359
- Fixed-reference final team error (same trajectory): 62921.492
- Dynamic graph switch count: 2
- Dynamic graph switch times (s): [45.400000000000006, 91.2]
