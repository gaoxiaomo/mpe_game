...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_000911`
- Quick mode: `True`
...
- Dynamic graph final team error: 503.906
- Fixed graph final team error ([26] baseline run): 461.624
- Fixed-reference final team error (same trajectory): 14099.083
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [5.4]
