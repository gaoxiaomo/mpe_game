...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_225240`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 159.880
- Final team error: 358.633
- Capture time (s): 34.75
...
- Dynamic graph final team error: 478.552
- Fixed graph final team error ([26] baseline run): 478.552
- Fixed-reference final team error (same trajectory): 478.552
