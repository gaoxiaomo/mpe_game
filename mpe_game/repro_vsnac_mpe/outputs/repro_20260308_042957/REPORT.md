...
- Output folder: `outputs\repro_20260308_042957`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 118.740
- Final team error: 225.649
- Capture time (s): 24.950000000000003

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 5781.488
- Fixed graph final team error ([26] baseline run): 4694.776
- Fixed-reference final team error (same trajectory): 199697.205
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [0.5]
