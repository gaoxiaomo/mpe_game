...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_014409`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 28176.501
- Final team error: 76129.996
- Capture time (s): None

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 63916.268
- Fixed graph final team error ([26] baseline run): 64195.046
- Fixed-reference final team error (same trajectory): 63916.268
- Dynamic graph switch count: 2
- Dynamic graph switch times (s): [44.7, 109.80000000000001]
