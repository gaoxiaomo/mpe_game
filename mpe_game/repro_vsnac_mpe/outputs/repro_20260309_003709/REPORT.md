...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_003709`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 159.403
- Final team error: 396.015
- Capture time (s): 39.45

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 467.446
- Fixed graph final team error ([26] baseline run): 460.549
- Fixed-reference final team error (same trajectory): 14488.900
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [7.9]
