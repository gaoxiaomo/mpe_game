...
- Output folder: `outputs\repro_20260308_131611`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 156.278
- Final team error: 267.819
- Capture time (s): 37.4

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 47083.653
- Fixed graph final team error ([26] baseline run): 17092.602
- Fixed-reference final team error (same trajectory): 791271.981
