...
- Output folder: `outputs\repro_20260308_141140`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 14549.066
- Final team error: 31822.898
- Capture time (s): None

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 43697.528
- Fixed graph final team error ([26] baseline run): 54514.533
- Fixed-reference final team error (same trajectory): 54548.167
- Dynamic graph switch count: 2
- Dynamic graph switch times (s): [6.0, 99.5]
