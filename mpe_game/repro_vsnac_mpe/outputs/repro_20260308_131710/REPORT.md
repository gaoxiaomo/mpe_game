...
- Output folder: `outputs\repro_20260308_131710`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 156.797
- Final team error: 268.491
- Capture time (s): 37.4

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 74443.595
- Fixed graph final team error ([26] baseline run): 17092.907
- Fixed-reference final team error (same trajectory): 74443.595
