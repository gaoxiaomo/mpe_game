...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260311_011233`
- Quick mode: `True`
...
- Dynamic graph final team error: 505.874
- Fixed graph final team error ([26] baseline run): 457.870
- Fixed-reference final team error (same trajectory): 20309.806
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [4.0]
