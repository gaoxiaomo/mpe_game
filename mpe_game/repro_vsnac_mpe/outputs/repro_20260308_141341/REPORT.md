...
- Output folder: `outputs\repro_20260308_141341`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 7299.872
- Final team error: 17055.263
- Capture time (s): None

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 21466.391
- Fixed graph final team error ([26] baseline run): 30498.881
- Fixed-reference final team error (same trajectory): 40050.650
