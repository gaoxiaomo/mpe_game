...
- Output folder: `outputs\repro_20260308_143258`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 156.930
- Final team error: 268.557
- Capture time (s): 37.4

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 47084.278
- Fixed graph final team error ([26] baseline run): 17097.946
- Fixed-reference final team error (same trajectory): 791309.946
