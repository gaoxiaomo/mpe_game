...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_210501`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 159.596
- Final team error: 375.988
- Capture time (s): 28.35
...
- Dynamic graph final team error: 350.182
- Fixed graph final team error ([26] baseline run): 410.170
- Fixed-reference final team error (same trajectory): 365530.834
- Dynamic graph switch count: 3
- Dynamic graph switch times (s): [2.75, 14.55, 16.2]
