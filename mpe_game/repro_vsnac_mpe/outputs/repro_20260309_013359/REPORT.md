...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_013359`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 159.477
- Final team error: 291.848
- Capture time (s): 31.05

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 541.902
- Fixed graph final team error ([26] baseline run): 541.881
- Fixed-reference final team error (same trajectory): 541.902
