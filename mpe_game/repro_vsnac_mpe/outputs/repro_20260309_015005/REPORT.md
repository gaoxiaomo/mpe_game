...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_015005`
- Quick mode: `True`
...
- Dynamic graph final team error: 486.468
- Fixed graph final team error ([26] baseline run): 542.637
- Fixed-reference final team error (same trajectory): 486.468
