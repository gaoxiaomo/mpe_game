...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_200142`
- Quick mode: `True`
...
- Dynamic graph final team error: 483.151
- Fixed graph final team error ([26] baseline run): 577.788
- Fixed-reference final team error (same trajectory): 101351.480
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [3.0]
