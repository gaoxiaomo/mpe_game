...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260308_231622`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 159.061
- Final team error: 278.796
- Capture time (s): 39.7

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 448.944
- Fixed graph final team error ([26] baseline run): 461.624
- Fixed-reference final team error (same trajectory): 34754.231
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [26.0]
