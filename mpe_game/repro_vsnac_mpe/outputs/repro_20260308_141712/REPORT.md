...
- Output folder: `outputs\repro_20260308_141712`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 156.938
- Final team error: 268.591
- Capture time (s): 37.4

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 74443.501
- Fixed graph final team error ([26] baseline run): 17095.859
- Fixed-reference final team error (same trajectory): 74443.501
- Dynamic graph switch count: 3
- Dynamic graph switch times (s): [16.0, 22.35, 27.950000000000003]
