...
- Output folder: `outputs\repro_20260308_043049`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 119.036
- Final team error: 226.026
- Capture time (s): 24.950000000000003

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 5781.454
- Fixed graph final team error ([26] baseline run): 4694.774
- Fixed-reference final team error (same trajectory): 205744.193
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [1.0]
