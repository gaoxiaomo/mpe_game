...
- Output folder: `outputs\repro_20260308_045104`
- Quick mode: `False`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 179.765
- Final team error: 207.950
- Capture time (s): 50.800000000000004

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 34695.695
- Fixed graph final team error ([26] baseline run): 2482.320
- Fixed-reference final team error (same trajectory): 431969.580
