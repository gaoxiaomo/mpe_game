...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260311_003452`
- Quick mode: `True`
...
- Dynamic graph final team error: 423.921
- Fixed graph final team error ([26] baseline run): 437.024
- Fixed-reference final team error (same trajectory): 13233.923
- Dynamic graph switch count: 1
- Dynamic graph switch times (s): [4.3]
