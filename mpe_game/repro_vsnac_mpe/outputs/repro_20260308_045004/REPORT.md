...
- Output folder: `outputs\repro_20260308_045004`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 179.590
- Final team error: 207.792
- Capture time (s): 50.800000000000004

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 3703.756
- Fixed graph final team error ([26] baseline run): 2482.076
- Fixed-reference final team error (same trajectory): 240632.448
