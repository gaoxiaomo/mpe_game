...
- Output folder: `E:\毕业设计\mpe_game\repro_vsnac_mpe\outputs\repro_20260309_012109`
- Quick mode: `True`

## Scenario 1 (3 pursuers, 1 evader)
- Final max assigned error: 159.794
- Final team error: 396.872
- Capture time (s): 39.35

## Scenario 2 (3 pursuers, 3 evaders)
- Dynamic graph final team error: 466.423
- Fixed graph final team error ([26] baseline run): 464.059
- Fixed-reference final team error (same trajectory): 14493.080
